<%@ Page Title="" Language="C#" MasterPageFile="~/LayoutC2.Master" AutoEventWireup="true" CodeBehind="Search.aspx.cs" Inherits="WebNCASP.Customer.Search" %>
          ...
          <div class="container-content">
            <div class="box-filter">
              ...
              <div class="filter-item review">
                ...
                <div class="filter-row">
                  <input type="checkbox" name="good" id="" /> Tốt (7.0 +)
                </div>
              </div>
            </div>
            <div class="tabs-container">
              <div class="tabs-header">
                <ul>
                  ...
                  <li>
                    <a href="search.html?sort=rank"><p>Xếp hạng sao</p></a>
